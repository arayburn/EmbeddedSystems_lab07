...
void PI_update(void) {
    ...
    /// TODO: calculate error signal and write to "error" variable
		motor_speed = motor_speed; // modify this if motor speed is not in rpm 
    ...
    /// TODO: Calculate integral portion of PI controller, write to "error_integral" variable
		error_integral = error_integral_previous + Ki*error;
    ...
    int16_t output = error_integral + proportional; 
